...
Para ejecutar los test de estr�s hay que bajarse en el Jmeter desde
...
y en luego cargar el archivo de con para realizar las pruebas que tambi�n se encuentra dentro de la carpeta, prueba.csv.
